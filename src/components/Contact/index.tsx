        ...
        <div className="container-fluid mx-auto flex flex-row items-center justify-center">
            <div className="w-10/12 lg:w-9/12 flex flex-col bg-white shadow-md my-10 p-5 border-2 rounded-lg">
                <div className="">
                    ...
                    <p className="font-quicksand my-4">Get in touch or send me an email at <strong>a.markdexter@gmail.com</strong></p>
                        ...
                        <form className="my-4">
                            <div className="flex flex-col gap-2 space-y-5">
                                <div className="flex flex-row w-full gap-3">
                                        <input 
                                         className="w-1/2
                                         p-2 border border-gray-800/70 rounded-md focus:border-transparent
                                         focus:outline-none focus:ring-2 focus:ring-teal-500/80 "
                                        type="text" 
                                        name="name" 
                                        placeholder="Name" 
                                        required 
                                ...
                                <input
                                    className="p-2 border border-gray-800/70 rounded-md
